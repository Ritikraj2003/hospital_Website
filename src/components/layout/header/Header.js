        ...
        <div className="container d-flex justify-content-between align-items-center py-2">
          <div className="d-flex align-items-center gap-3">
            <div className="d-flex align-items-center gap-2">
              <a href="tel:+919931212664" className="d-flex align-items-center text-white text-decoration-none">
                ...
                <span className="fw_med fs_12 lh_16">+91 99312 12664</span>
              </a>
            </div>
            <div className="d-flex align-items-center gap-2">
              <a href="mailto:avnihospital2026@gmail.com" className="d-flex align-items-center text-white text-decoration-none">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" className="mr_7">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
                  <polyline points="22,6 12,13 2,6" />
                </svg>
                <span className="fw_med fs_12 lh_16">avnihospital2026@gmail.com</span>
              </a>
            </div>
          </div>
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <Link
              href="/insurance-cashless-facility"
              className="btn btn-sm text-white ms-2 fw-bold shadow-sm d-flex align-items-center gap-1"
              style={{ fontSize: "12px", border: "1px solid rgba(255,255,255,0.5)", background: "rgba(255,255,255,0.15)", borderRadius: "4px", padding: "4px 10px" }}
            >
              <span>🛡️</span> Cashless Insurance
            </Link>
            <button
